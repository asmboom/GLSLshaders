        ...
        loader.load('data/building.json', function (scn) {
            ...
            :
                ...
                === === =
                    value
            :
                new THREE.Vector4(350.0, 400.0, 600.0, 0.0)
            }
            ,
            lightDiff: {
                type: "v4",
                    value
            :
                new THREE.Vector4(1.0, 0.964, 0.714, 1.0)
            }
            ,
            sceneAmbient: {
                type: "v3",
                    value
            :
                new THREE.Vector3(0.26, 0.44, 0.624)
                >>> >>> > a052683c9fc62595f8312a46349c9ee03ea73865
            }
            ,
            fogColor: {
                type: "v3",
                    value
            :
                new THREE.Vector3(0.2, 0.247, 0.278)
            }
            ,
            texture1: {
                type: "t",
                    value
            :
                THREE.ImageUtils.loadTexture("data/buildingsAtlas.jpg")
            }
            ,
            textureSpec: {
                type: "t",
                    value
            :
                THREE.ImageUtils.loadTexture("data/buildingsAtlas_spec.jpg")
            }
            ,
            shininess: {
                type: "f",
