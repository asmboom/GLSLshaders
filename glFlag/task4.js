...
require(["threejs", "gui",
        //Shaders
        "text!data/shaders/flag.vert",
        "text!data/shaders/flag.frag"
    ],
    function(threejs, xGUI, flagV, flagF) {
        ...
        function init() {
            ...
            loader.load('data/flag.json', function(scn) {
                ...
                uniforms = {
                    ...
                    textureCloud: {
                        type: "t",
                        value: THREE.ImageUtils.loadTexture("data/noise.jpg")
                    },
                    speed: {
                        type: "f",
                        value: 5.0
            ...
            shaderGUI.add(shaderConfig, 'amplitude', 0, 3).onChange(function() {
